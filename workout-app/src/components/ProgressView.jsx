...
import { Search, X, TrendingUp, Calendar, Flame, ChevronRight } from 'lucide-react'
import {
...
function CustomTooltip({ active, payload, label }) {
  ...
  return (
    <div className="rounded-xl px-3 py-2 text-sm" style={{ background: '#1e1e1e', border: '1px solid #2a2a2a' }}>
      ...
      <div className="font-bold" style={{ color: '#00d4ff' }}>{payload[0].value} lbs</div>
    </div>
  )
}
